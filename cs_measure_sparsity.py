    ...
    for n_qubits in n_qubits_list:
        ...
        for seed in seeds:
            data, data_fname, data_dir = load_grid_search_data(
                ...
                noise=noise, beta_step=bs, gamma_step=gs, seed=seed, device=device,
...
if __name__ == "__main__":
    ...
    if args.aim == 'large1':
        ...
        recon_landscapes_varying_qubits_and_instances(p=args.p, ansatz=args.ansatz, problem=args.problem,
            noise=args.noise, n_seeds=args.n_seeds, n_qubits_list=args.ns, error_type=args.error, device=args.device)
    else:
